...
@Composable
fun LunchTrayAppBar(currentScreenTitle: Int, canNavigateBack: Boolean, navigateUp: () -> Unit, modifier: Modifier = Modifier) {
        ...
        NavHost(navController = navController, startDestination = LunchTrayScreen.Start.name) {
            ...
            composable(route = LunchTrayScreen.SideDish.name) {
                SideDishMenuScreen(
                    ...
                    onCancelButtonClicked = {
                        viewModel.resetOrder()
                        navController.popBackStack(LunchTrayScreen.Entree.name, inclusive = false)
                    },
            ...
            composable(route = LunchTrayScreen.Accompaniment.name) {
                AccompanimentMenuScreen(
                    ...
                    onCancelButtonClicked = {
                        viewModel.resetOrder()
                        navController.popBackStack(LunchTrayScreen.SideDish.name, inclusive = false)
                    },
